...
export default function MyModal({setShowModal, handleHnumber, setX}) {
  let [isOpen, setIsOpen] = useState(true)

  function closeModal(hNumber) {
    setIsOpen(false)
    setShowModal(false)
    hNumber > 0 ?
